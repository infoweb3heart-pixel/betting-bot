...
# --- Double Chance (fallback when no clear 1X2 winner) ---
# the-odds-api doesn't publish a Double Chance market for soccer on the free
# plan, so this is computed as a fair/implied price from true probabilities
# (no bookmaker margin) rather than a live quote -- always shown as estimated.
DC_MIN_COMBINED_PROB = 0.65   # the two covered outcomes must add up to at least this
DC_MIN_ODDS = 1.15
DC_MAX_ODDS = 1.60
